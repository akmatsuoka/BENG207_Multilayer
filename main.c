...
#define OUTPUT_DIR "/home/shh/Projects/BENG207_Multilayer/"

/* ============================================================
 * Material parameters (Adjusted to fit parameters currently used)
 * ============================================================ */

/* Layer 1: Lithium Niobate LiNbO3 transducer (source) */
static const double rho_1     = 4647.0;    /* kg/m^3 */
static const double c_1_long  = 6570.0;    /* m/s longitudinal */

/* Layer 2: Ultrasound gel couplant (Kelvin-Voigt) */
...
/* Layer 3: Silica Glass (changed from borosilicate glass) */
...
static const double c_w   = 1500.0;        /* m/s */

/* Actuation (changed from 20 MHz to 750 kHz) */
static const double f_center = 7.5e7;     /* 0.75 MHz */
